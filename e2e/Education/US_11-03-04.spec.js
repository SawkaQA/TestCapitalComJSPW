...
test.describe("Educations > Menu item [Position Trading]  on UnReg Role", () => {
  let header;
  let login;
  let page;
...
test.describe("Educations > Menu item [Position Trading] on UnAuth Role", () => {
  let header;
  let login;
  let page;
  ...
  test.beforeAll(async ({ browser }) => {
    ...
    if (await isVisiblePosition.isVisible()) {
      ...
      test.skip("Education->Position Trading page doesn't exist on '${language}' language");
    }
  })
...
test.describe("Educations > Menu item [Position Trading] on Auth Role", () => {
  let header;
  let login;
  let page;
